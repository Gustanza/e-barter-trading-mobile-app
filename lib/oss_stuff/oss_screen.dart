...
class _MsajiliState extends State<Msajili> {
  ...
  Future<void> mratibuDeits() async {
    ...
    var msgObj = FirebaseMessaging.instance;
    ...
    await kisajilishi.currentUser?.updatePhotoURL(eBMUdefaultP);
    //mwisho hapa
    var mimi = obj.currentUser?.email;
    var picha = obj.currentUser?.photoURL;
    var tokenYangu = await msgObj.getToken();
    ...
    try {
      await FirebaseFirestore.instance
          ...
          .set({
        eBMUpicha: picha,
        eBMUname: obj.currentUser?.displayName,
        softtokey: tokenYangu,
        lokesheni: mkoaSelected,
        nahitaji: []
      });
    } catch (shida) {
